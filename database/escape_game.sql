...
--
-- Table structure for table `game_score_details`
--

CREATE TABLE `game_score_details` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
(6, '2025_02_10_164541_create_sessions_table', 1),
(7, '2025_03_28_144227_create_game_list_table', 1),
(8, '2025_03_28_144241_create_game_score_details_table', 1),
(9, '2025_03_30_101453_add_logged_data_column_to_game_score_details_table', 1);
...
--
-- Indexes for table `game_score_details`
--
ALTER TABLE `game_score_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `game_score_details_user_id_foreign` (`user_id`),
  ADD KEY `game_score_details_game_id_foreign` (`game_id`);
...
--
-- AUTO_INCREMENT for table `game_score_details`
--
ALTER TABLE `game_score_details`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `game_score_details`
--
ALTER TABLE `game_score_details`
  ADD CONSTRAINT `game_score_details_game_id_foreign` FOREIGN KEY (`game_id`) REFERENCES `game_list` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `game_score_details_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
